                    ...
                    <form className="card" onSubmit={handleSubmit}>
                      <div className="card-header">
                        <h3 className="card-title">
                          Add {categorytitle} Recommendation
                        </h3>
                      </div>
                      <div className="card-body">
                        <div className="row">
                          ...
                          {categorytitle !== 'Stock Fundamentals' ||
                          categorytitle !== 'Crypto Fundamentals' ? (
                            <>
                              <div className="col-md-12">
                                <div className="form-group">
                                  <label className="form-label">
                          ...
                          <div className="col-sm-12 col-md-4">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setMarketCaptilization(e.target.value)
                                }
                              />
                            </div>
                          </div>
                              ...
                              <div className="col-md-12">
                                <div className="form-group mb-0">
                                  ...
                                  <select
                                    ...
                                    onChange={(e) =>
                                      setisDetailedReport(e.target.value)
                                    }
                                  >
                              ...
                              <div className="col-md-3">
                                <div className="form-group mb-0">
                                  ...
                                  <input
                                    ...
                                    name={three_months}
                                    onChange={(e) =>
                                      setthree_months(e.target.value)
                                    }
                                  />
                                </div>
                              </div>
