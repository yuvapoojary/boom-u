              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s1.png"
                      alt=""
                    />
                    <h6>Your Life</h6>
                    <p>74,853 views</p>
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s2.png"
                      alt=""
                    />
                    <h6>Unboxing Cool</h6>
                    <p>74,853 views</p>
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s3.png"
                      alt=""
                    />
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s4.png"
                      alt=""
                    />
                    <h6>
                      Gaming{' '}
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s5.png"
                      alt=""
                    />
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s6.png"
                      alt=""
                    />
                    <h6>Singing</h6>
                    <p>74,853 views</p>
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s7.png"
                      alt=""
                    />
                    <h6>Cooking</h6>
                    <p>74,853 views</p>
              ...
              <div className="item">
                <div className="category-item">
                  <a href="#">
                    <img
                      className="img-fluid"
                      src="%PUBLIC_URL%/assets/img/s8.png"
                      alt=""
                    />
                    <h6>Traveling</h6>
                    <p>74,853 views</p>
