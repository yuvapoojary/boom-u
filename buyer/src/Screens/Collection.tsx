...
if(Object.keys(recomm).length > 0
  ...
  <div className="row">
    ...
    <div className="col-md-4 right">
      ...
      <button className="btn btn-lg btn-primary" onClick={follow}>Follow {seller.Username}</button>
    ...
    <div className="col-md-2 text-right">
      ...
      <a href={`/give-rating/${sellerID}`} className="btn btn-lg btn-primary" >Give Rating</a>
    </div>
      </div>
    </div>
